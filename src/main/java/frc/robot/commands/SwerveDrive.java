...
public class SwerveDrive extends CommandBase {
  ...
  public void execute() {
    ...
    rotationSpeed =
        rotationLimiter.calculate(rotationSpeed) * Constants.Motor.SWERVE_ROTATION_MAX_SPEED;
    ...
    SwerveModuleState[] moduleState =
        Constants.Motor.SWERVE_DRIVE_KINEMATICS.toSwerveModuleStates(chassisSpeeds);
